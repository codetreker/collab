...
func TestCHN_8_CovBump_v6_HB5RetentionOverride(t *testing.T) {
	t.Parallel()
...
func TestCHN_8_CovBump_v6_ChannelMute(t *testing.T) {
	t.Parallel()
...
func TestCHN_8_CovBump_v6_StoreChannelGroupOps(t *testing.T) {
	t.Parallel()
...
func TestCHN_8_CovBump_v6_AdminActionsExtra(t *testing.T) {
	t.Parallel()
	ts, _, _ := testutil.NewTestServer(t)
	ownerToken := testutil.LoginAs(t, ts.URL, "owner@test.com", "password123")
	adminToken := testutil.LoginAsAdmin(t, ts.URL)
