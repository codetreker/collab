...
// TestCV22_AgentCannotCreateAnchor pins 立场 ① 反约束三连之一: agent role
...
// TestCV22_AnchorPinnedToVersion_Immutable pins 立场 ② 反约束: artifact
...
// TestCV22_AddCommentPushesFrame pins 立场 ③: AddComment hits the
