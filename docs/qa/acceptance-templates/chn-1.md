...
> 拆 PR: **CHN-1.1** schema (#276 merged b6e95ce) + **CHN-1.2** API handler (#286 merged f7ac4ed)
> Owner: 战马A 实施 / 烈马 验收
...
- 数据契约 4 项 + 行为不变量 5 项**全绿** (一票否决)
- AP-1 严格 403 (3.1) ⏸️ pending Phase 4, 不挡 CHN-1 闭合
- 登记 `docs/qa/regression-registry.md` REG-CHN1-001..007 (其中 -007 ⏸️ pending)
