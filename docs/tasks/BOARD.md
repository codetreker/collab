...
| COL-BUG-002 | 文件路径没有变成可点击链接 | In Review | 烈马 | [#119](https://github.com/codetreker/collab/pull/119) | 移除 agentId 条件，拓宽路径正则 |
...
| COL-BUG-010 | Dev 模式 WS 绕过认证 | In Progress | 战马 | — | NODE_ENV=development 时绕过 |
