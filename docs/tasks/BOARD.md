...
|----|-----|------|-------|--------|----|----- |
| COL-BUG-001 | 删除消息权限：用户能删别人的消息 | Done | 战马 | — | — | 代码已有正确权限控制，不可复现 |
| COL-BUG-002 | 文件路径没有变成可点击链接 | Done | 烈马 | — | [#119](https://github.com/codetreker/collab/pull/119) | 移除 agentId 条件，拓宽路径正则 |
| COL-BUG-003 | 亮色主题下侧边栏和 Workspace 仍是暗色 | Done | 战马 | — | — | 代码已正确实现，不可复现 |
| COL-BUG-004 | Enter/Ctrl+Enter 键位对调 | Done | 战马 | — | — | 当前行为正确，不可复现 |
...
| COL-BUG-010 | Dev 模式 WS 绕过认证 | Done | 战马 | — | — | [#121](https://github.com/codetreker/collab/pull/121) | 双条件 opt-in |
...
| COL-B15 | Collab Plugin Skill | Done | 飞马 | — | [#122](https://github.com/codetreker/collab/pull/122) | [prd](COL-B15/prd.md) | Plugin 内置 skill |
| COL-B19 | Remote Explorer | Backlog | 野马 | — | — | [direction](COL-B19/direction.md) | 远程文件浏览，只读 v1 |
| COL-B23 | 聊天记录分页加载 | Done | 战马 | — | [#81](https://github.com/codetreker/collab/pull/81) | — | 初始加载最近100条 |
