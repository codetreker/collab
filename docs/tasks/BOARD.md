...
| COL-T01 | 项目脚手架（Fastify + Vite + React + TS） | Ready | 战马 | — |
| COL-T02 | 数据库 schema + 基础 CRUD | Ready | 战马 | — |
| COL-T02b | 初始 seed 脚本 | Ready | 战马 | — |
| COL-T02c | 骨架部署验证（docker-compose + CF Tunnel） | Ready | 战马 | — |
...
| ID | 任务 | 状态 | Owner | PR |
|----|------|------|-------|----|
| COL-T03 | REST API — 频道 | Backlog | 战马 | — |
| COL-T04 | REST API — 消息 | Backlog | 战马 | — |
| COL-T04b | 图片上传 API + 前端 | Backlog | 战马 | — |
| COL-T05 | REST API — 用户 + 认证 | Backlog | 战马 | — |
| COL-T06 | WebSocket 服务 | Backlog | 战马 | — |
| COL-T07 | 长轮询 API（Plugin 用） | Backlog | 战马 | — |
