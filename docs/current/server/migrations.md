...
| 7 | `cm_onboarding_welcome` | Phase 2 / CM-onboarding | Welcome channel 自动建 + 首条欢迎语 (PR #203)。 |
| 8 | `ap_0_bis_message_read` | Phase 2 / AP-0-bis | `message.read` 默认权限 backfill (#41 派活)。 |
