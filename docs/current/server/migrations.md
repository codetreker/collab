...
## 8. Phase 3 + Phase 4 入口 migration sequence (v=13 ~ v=19)

> 跟 spec brief sequencing 锁字面延续: CV-1.1 v=13 / CV-2.1 v=14 / DM-2.1 v=15 / AL-4.1 v=16 / CV-3.1 v=17 / CV-4.1 v=18 / CHN-3.1 v=19 / CHN-4.1 v=20 (占位无 schema 改). 真先到先拿 — CV-2.1 抢 v=14, DM-2.1 顺延 v=15, AL-4.1 顺延 v=16, CV-3.1 v=17, CV-4.1 v=18 ✅ (#405), CHN-3.1 v=19 ✅ (#410).
