...
> v=6 reserved for ADM-0.3 (users.role enum 收 + admin backfill + session revoke), 战马A in-flight。
> v=9 (cm_3_org_id_backfill) + v=10 (ADM-0.3) 由 owner 在各自 PR 内补本节小节 (规则 6 同步)。
