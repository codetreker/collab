...
| Phase 4+ 剩余模块 | ✅ DONE | G4.1-G4.5 + G4.audit closure | **54/54 milestone (含 10 follow-up wave: WIRE-1/HB-2-V0D-E2E/ADM-3-V1-E2E/ULID-MIGRATION/HB-1B-INSTALLER/CAPABILITY-DOT/ADM-2-FOLLOWUP/DEFERRED-UNWIND/Dockerfile-FTS5/ADMIN-SPA-SHAPE-FIX), REG 815**, cov 85%+. → [`progress/phase-4.md`](progress/phase-4.md) |
